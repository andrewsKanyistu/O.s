	...
	*/
	...
	if (child == 0) {				/* Codice del figlio: consumatore */
		...
		do {
			...
			*/
			...
			/* 
				...
				entra nella regione critica eseguendo una V sul semaforo
				MUTEX e inizia la lettura vera e propria.
			*/			
			sem_wait(MUTEX);
		...
		*/
		...
		/* DA QUI IN POI COMPLETARE IL CODICE DEL PADRE */
		
		
		/* 
			la memoria condivisa deve essere mappata nell'area dati del padre
